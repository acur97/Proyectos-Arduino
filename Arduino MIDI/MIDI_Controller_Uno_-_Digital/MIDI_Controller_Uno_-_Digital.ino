...
#define NUMBER_OF_ANALOG_INPUTS  1 // The Uno has 6 analog inputs, we'll use all of them in this example. If you only need 4, change this to 4, and you'll be able to use A4 & A5 as normal I/O pins.
